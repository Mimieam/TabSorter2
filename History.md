...
#### **Suggestions:**
  ...
  - [x] ignore params after special characters - #,& ( expected to affect - sorting, deduplicating)
...
These are some ideas that I have been thinking about, but have yet to figure out their feasibility and if they are worth investing dev time.
  ...
  - [x] Add group support to sorting/merging/split
...
#
**[v2.1.0](https://github.com/Mimieam/TabSorter2/discussions/33)** - 09/13/2022 (Released)
#### **Added:**
